          ...
          <section class="vbox">          
            <section class="scrollable padder">
              ...
              <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                ...
                <li class="active"><a href="{{url('admin/users/'.strtolower($data['page']))}}">{{$data['page']}}</a></li>
              </ul>
            ...
            <div class="col-lg-12">
              <section class="panel panel-default">
                ...
                <div class="col-lg-12 text-right">
                 <a href="{{url('admin/users/'.strtolower($data['page']).'/add')}}" class="btn btn-primary" title="Add"><i class="fa fa-plus"></i> Create</a>
                </div>

                <br><br><br>

                 <form action="{{url('admin/users/'.$data['page']).'/search'}}" method="post" enctype="multipart/form-data">
                    @csrf
