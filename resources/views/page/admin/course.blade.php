...
<section id="content">
          <section class="vbox">          
            <section class="scrollable padder">
              ...
              @if($data['page']=='Main')<?php $title = 'Course';?>@else<?php $title = $data['page'];?>@endif
              <div class="m-b-md">
            ...
            <div class="col-lg-12">
              ...
              <section class="panel panel-default">
                ...
                <div class="col-lg-12 text-right">
                 <a href="{{url('admin/course/'.strtolower($data['page']).'/add')}}" class="btn btn-primary" title="Add"><i class="fa fa-plus"></i> Create</a>
                </div>
