...
<div class="col-sm-12">
 ...
 @endif
    ...
    @if(file_exists(public_path().'/upload/admin/profile/images/'.$data['detail']['image']) && $data['detail']['image'] != null)
    <input type="hidden" name="img_hidden" value="{{$data['detail']['image']}}">
    <?php $img = asset('upload/admin/profile/images/'.$data['detail']['image']);?>
    @else
        ...
        <div class="col-sm-6">
            ...
            @if($data['action']=='Create')
             ...
             <div class="col-sm-12">
              ...
              <input name="password" type="text" class="form-control" placeholder="Password 8 digits" maxlength="6" id="show_gen_pass" required>
         ...
         <div class="col-sm-6">
            ...
            <div class="col-sm-12">
              ...
              <input name="birthday" type="text" class="form-control" placeholder="Birthday" value="{{$birthday}}">
            </div>

            <div class="col-sm-12">
                <br>
              <label>ID Card No.</label>
              <input name="id_card" type="text" class="form-control" placeholder="ID Card No." value="{{$id_card}}" required>
            </div>
