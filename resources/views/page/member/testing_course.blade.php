...
<section id="mu-course-content">
    <div class="container">
     <div class="row">
      ...
      <div class="container">
        ...
        @if(count($data['detail']['pretest_posttest_header']))
      
        @if($data['step']==1)
        <?php $step1 = null;?>
        @else
        <?php $step1 = "disabled=disabled";?>
        @endif

        @if($data['step']==2)
        <?php $step2 = null;?>
        @else
        <?php $step2 = "disabled=disabled";?>
        @endif

        @if($data['step']==3)
        <?php $step3 = null;?>
        @else
        <?php $step3 = "disabled=disabled";?>
        @endif
    ...
    <div class="alert">
        <div class="row" align="center">
            <div class="col-xs-4"> 
                <a href="javascript:void();" type="button" class="btn btn-primary btn-circle" <?php echo $step1;?>>Step 1</a>
                <p>Pre Test</p>
            </div>
            <div class="stepwizard-step col-xs-4"> 
                <a href="javascript:void();" type="button" class="btn btn-primary btn-circle" <?php echo $step2;?>>Step 2</a>
                <p>Lesson</p>
            </div>
            <div class="stepwizard-step col-xs-4"> 
                <a href="javascript:void();" type="button" class="btn btn-primary btn-circle" <?php echo $step3;?>>Step 3</a>
                <p>Post Test</p>
            </div>
<!--             <div class="stepwizard-step col-xs-3"> 
    ...
    <form id="testing_course_save" name="testing_course_save">
      ...
      @if($data['step']==1)
        ...
        <div class="panel panel-info" id="step-1">
        ...
        <div class="panel panel-info" id="step-2">
            ...
            <div class="panel-body">
              ...
              <br>
                ...
                <td>
                @if(count($data['detail']['file_lesson'][$key])>0)
                ...
                <td>
                <a href="javascript:void();" class="btn btn-info" onclick="show_lesson('{{$value->lesson_name}}','{{$value->lesson_vdo_url}}','{{json_encode($value->lesson_content)}}');">Open</a>
                </td>
                </tr>
                @endforeach
                @else
